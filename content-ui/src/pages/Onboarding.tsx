    ...
    <>
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          ...
          >
            Register your brand profile to generate compliant, on-brand content
            at scale.
          </p>
          {/* Feature pills */}
          <div
          ...
          {tabs.map((tab) => (
            <button
              ...
              style={{
                ...
                boxShadow:
                  activeTab === tab.key
                    ? `inset 0 0 0 1px ${D.borderAccent}`
                    : "none",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
                {[
                  {
                    label: "Tone",
                    value: "Professional, bold, founder-friendly",
                    icon: "🎯",
                  },
                  {
                    label: "Banned",
                    value: "guaranteed, risk-free, 100% secure, zero fraud",
                    icon: "🚫",
                  },
                  {
                    label: "Disclaimers",
                    value: "Subject to RBI guidelines, T&C apply",
                    icon: "⚖️",
                  },
                  {
                    label: "Persona",
                    value: "Indian startup founders and finance teams",
                    icon: "👥",
                  },
                ].map((item) => (
                  <div
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div>
                ...
                <input
                  className="ob-input"
                  style={inputStyle}
                  placeholder="Founder-friendly, clear, concise"
              ...
              <div>
                ...
                <input
                  className="ob-input"
                  style={inputStyle}
                  placeholder="guaranteed, risk-free, 100% secure"
                  value={form.banned_words}
                  onChange={(e) =>
                    setForm({ ...form, banned_words: e.target.value })
                  }
                />
              </div>
              <div>
                ...
                <input
                  className="ob-input"
                  style={inputStyle}
                  placeholder="Subject to RBI guidelines, T&C apply"
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, default_persona: e.target.value })
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, writing_rules: e.target.value })
                    }
                  />
                </div>
              </div>
          ...
          {activeTab === "url" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              >
                ...
                >
                  Enter your company website or LinkedIn URL. We auto-detect
                  brand voice, tone, vocabulary, and style.
                </p>
              </div>
              <div>
          ...
          <div style={{ marginTop: 20 }}>
            {activeTab === "demo" ? (
              ...
              <button
                className="ob-submit"
                onClick={
                  activeTab === "form" ? handleFormSubmit : handleUrlSubmit
                }
                disabled={loading}
                style={{
                  width: "100%",
