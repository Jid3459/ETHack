...
function ImpactCard({
  ...
  return (
    ...
    >
      ...
      {sub && (
        <div style={{ color: D.sub, fontSize: 10.5, lineHeight: 1.5 }}>
          {sub}
        </div>
      )}
    </motion.div>
    ...
    >
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ color: D.sub, fontSize: 10, marginTop: 3 }}>
            Monthly savings
          </div>
        </div>
        <div style={{ textAlign: "center" }}>
      ...
      >
        Manual benchmark: 5h/piece · ContentShield: ~45 min including human
        review
      </div>
    </motion.div>
  );
...
export default function ROIImpactStrip({ companyId }: { companyId: string }) {
    ...
    fetch(`${BASE}/roi/${companyId}`)
      ...
      .catch(() => {
        ...
        setMetrics({
          ...
          completed_runs: 3,
          pieces_published: 2,
          brand_violations_caught: 7,
          legal_flags_prevented: 3,
          revisions_automated: 5,
          hours_saved: 12.75,
          cost_saved_inr: 10200,
          avg_brand_score: 91,
          cycle_time_reduction_pct: 85,
        });
      });
  }, [companyId]);
  ...
  const cards = [
    ...
    {
      icon: "⬡",
      value: metrics.brand_violations_caught,
    ...
    {
      icon: "⚖",
      value: metrics.legal_flags_prevented,
      label: "Legal Risks Stopped",
      color: "#f59e0b",
      delay: 0.21,
    ...
    {
      icon: "↺",
      value: metrics.revisions_automated,
      ...
      >
        <div
          style={{
            ...
            flex: 1,
            background:
              "linear-gradient(90deg, rgba(59,130,246,0.4), rgba(139,92,246,0.1))",
          }}
        />
        <span
          style={{
