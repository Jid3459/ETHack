        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              padding: 0, transition: 'opacity 0.2s', flexShrink: 0,
            }}
          >
            <div style={{
            ...
            <span style={{
              color: '#f0f4ff', fontWeight: 800, fontSize: 13.5,
              letterSpacing: '-0.01em', fontFamily: "'Syne', sans-serif",
            }}>ContentShield</span>
            {companyName && (
              <span style={{
                color: '#3b82f6', fontSize: 10.5, fontWeight: 600,
            ...
            {links.map(link => {
              ...
              return (
                <Link
                  ...
                  className="nav-link"
                  style={{
                    color: isActive ? '#e2e8f0' : isDash ? '#8b5cf6' : '#3a4560',
                    textDecoration: 'none',
                    fontSize: 12,
                    fontWeight: isActive ? 700 : isDash ? 600 : 400,
                    padding: '5px 11px',
                    borderRadius: 8,
                ...
                >
                  <span style={{
                    ...
                    color: isActive ? '#3b82f6' : isDash ? '#8b5cf6' : 'inherit',
                  }}>{link.icon}</span>
                  {link.label}
                  {isActive && (
                    <span style={{
