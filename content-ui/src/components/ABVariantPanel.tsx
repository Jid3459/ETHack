 ...
 *   if (abMode) {
 *     const res = await fetch('http://localhost:8000/run/variants', {
 *       method: 'POST',
          ...
          >
            {[
              ...
              >
                ...
                <span
                  style={{ color: v.color, fontSize: 10.5, fontWeight: 600 }}
                >
                  {v.desc}
                </span>
              </div>
...
export function ABResultCard({ abGroupId }: { abGroupId: string }) {
  ...
  if (loading)
    return (
      <div style={{ color: D.sub, fontSize: 12, padding: "8px 0" }}>
        Loading A/B results…
      </div>
    );
  ...
  return (
    <div>
      ...
      >
        ...
        {!result.winner_label &&
          result.variants.some((v) => !v.feedback_collected) && (
          ...
          return (
            ...
            >
              ...
              >
                ...
                {!v.pipeline_complete && (
                  <span
                    style={{ color: D.dim, fontSize: 10, marginLeft: "auto" }}
                  >
                    Running…
                  </span>
                )}
